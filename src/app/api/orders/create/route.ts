...
interface CreateOrderRequest {
    orderCode?: string; // Pre-generated by client
    customerCode?: string; // Pre-generated by client
    items: OrderItem[];
    totalPrice: number;
...
export async function POST(request: NextRequest) {
    try {
        ...
        // Use client-provided codes or generate new ones
        const orderCode = clientOrderCode || generateId.order();
        const customerCode = clientCustomerCode || user.customer_code || generateId.user();
