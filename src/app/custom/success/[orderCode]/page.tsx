            ...
            <div className="min-h-screen bg-[#0a0a0a] pt-28 pb-20">
                <div className="max-w-[600px] mx-auto px-6">
                    <AnimatedSection className="text-center mb-8">
                        <h1 className="text-3xl font-bold text-white mb-2">Please Pay</h1>
                        <p className="text-white/60">Scan QR to complete the order</p>
                    </AnimatedSection>
                            ...
                            <div className="space-y-4 mb-8">
                                <div className="bg-white/5 rounded-xl p-4 space-y-3">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-white font-medium">{accountNo}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                                    ...
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-white font-mono">{transferContent}</span>
                                    </div>
                                </div>
                            </div>
        ...
        <div className="min-h-screen bg-[#0a0a0a] pt-28 pb-20">
            <div className="max-w-[800px] mx-auto px-6">
                <AnimatedSection className="text-center mb-10">
                    ...
                    <p className="text-white/60">Order code: <span className="font-mono text-white">{order.order_code}</span></p>
                </AnimatedSection>

                <div className="bg-[#1D1D1F] rounded-3xl p-8 border border-white/10">
                    ...
                    <div className="border-t border-white/10 mt-6 pt-4 flex justify-between">
                        ...
                        <span className="text-white font-semibold">{order.total.toLocaleString('vi-VN')}d</span>
                    </div>
                </div>
