-- =============================================================================
-- MIGRATION: Consolidate Order Tables
-- Run this in Supabase SQL Editor
-- =============================================================================

-- 1. Add supporting columns to main 'orders' table
...
-- 2. Migrate data from 'custom_orders' (Legacy) -> 'orders'
...
-- 3. Migrate data from 'print_orders' (Legacy) -> 'orders'
INSERT INTO public.orders (
...
-- 4. Cleanup (Uncomment when verified)
